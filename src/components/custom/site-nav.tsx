...
// Session seam. better-auth provides useSession() via @/lib/auth-client
// (client-safe; reads the user/role without server-only imports). Return
// `false` while pending so SSR markup doesn't flash "logged in" for anonymous
// visitors; once resolved, items whose `requiresAuth` is true appear.
